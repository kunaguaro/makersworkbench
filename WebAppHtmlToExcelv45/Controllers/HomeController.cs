    ...
    public class HomeController : Controller
    {
        ...
        public FileResult WriteDataToExcel()
        {
            ...
            using (var libro = new ExcelPackage())
            {
                ...
                //create a new BarChart of type Pie
                ExcelPieChart pieChar2 = worksheet.Drawings.AddChart("pieChar2", eChartType.Pie) as ExcelPieChart;

                //set the title
                pieChar2.Title.Text = "Ejemplo: Grafica de Pie 2";

                //select the ranges for the pie. First the values, then the header range
                pieChar2.Series.Add(ExcelRange.GetAddress(2, 1, 2, 10), ExcelRange.GetAddress(1, 1, 1, 10));

                //position of the legend
                pieChar2.Legend.Position = eLegendPosition.Bottom;

                //show the percentages in the pie
                pieChar2.DataLabel.ShowPercent = true;

                //size of the chart
                pieChar2.SetSize(500, 400);

                //add the chart at cell A27
                pieChar2.SetPosition(26, 0, 2, 0);



                //create a new BarChart of type Pie
                ExcelPieChart pieChar3 = worksheet.Drawings.AddChart("pieChar3", eChartType.PieExploded) as ExcelPieChart;

                //set the title
                pieChar3.Title.Text = "Ejemplo: Grafica de Pie 3";

                //select the ranges for the pie. First the values, then the header range
                pieChar3.Series.Add(ExcelRange.GetAddress(2, 1, 2, 10), ExcelRange.GetAddress(1, 1, 1, 10));

                //position of the legend
                pieChar3.Legend.Position = eLegendPosition.Bottom;

                //show the percentages in the pie
                pieChar3.DataLabel.ShowPercent = true;

                //size of the chart
                pieChar3.SetSize(500, 400);

                //add the chart at cell K27
                pieChar3.SetPosition(26, 0, 10, 0);



                //create a new BarChart of type BarClustered
                ExcelBarChart barChart2 = worksheet.Drawings.AddChart("barChart 2", eChartType.BarStacked3D) as ExcelBarChart;

                //set the title
                barChart2.Title.Text = "Ejemplo: Grafica de Barra  2 ";

                //select the ranges for the bar. First the values, then the header range
                barChart2.Series.Add(ExcelRange.GetAddress(2, 1, 2, 10), ExcelRange.GetAddress(1, 1, 1, 10));

                //position of the legend
                barChart2.Legend.Position = eLegendPosition.Bottom;
                ...
                //add the chart at cell K5
                barChart2.SetPosition(4, 0, 18, 0);

                


                //create a new BarChart of type BarClustered
                ExcelLineChart barChart3 = worksheet.Drawings.AddChart("linea chart", eChartType.Line) as ExcelLineChart;

                //set the title
                barChart3.Title.Text = "Ejemplo: Grafica de Linea  3 ";

                //select the ranges for the bar. First the values, then the header range
                barChart3.Series.Add(ExcelRange.GetAddress(2, 1, 2, 10), ExcelRange.GetAddress(1, 1, 1, 10));

                //position of the legend
                barChart3.Legend.Position = eLegendPosition.Bottom;


                //size of the chart
                barChart3.SetSize(500, 400);

                //add the chart at cell K5
                barChart3.SetPosition(27, 0, 18, 0);
